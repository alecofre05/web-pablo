...
export const Info = () => {
    ...
    return (
        <nav className="navbar" id="nb-color">
            <a className="nav-link anchor" id="mail-info" href={`https://mail.google.com/mail/?view=cm&fs=1&to=${email}`} target="_blank" rel="noopener noreferrer"><i className="fa fa-envelope-o"></i>{email}</a>
