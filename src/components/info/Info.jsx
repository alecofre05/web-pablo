...
export const Info = () => {
    ...
    return (
        <nav className="navbar" id="nb-color">
            ...
            <a className="nav-link" id="phone-info" aria-current="page" href={`https://api.whatsapp.com/send?phone=+549${phone}`} target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-whatsapp"></i>11-3820-7357 Consultanos</a>
        </nav>
    )
}
